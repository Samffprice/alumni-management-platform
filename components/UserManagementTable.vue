<template>
  <div class="bg-white shadow-soft rounded-2xl border border-gray-100/60 overflow-hidden">
    <!-- Table Header -->
    <div class="px-8 py-6 bg-gradient-to-r from-aggie-50/50 to-white border-b border-gray-100/60">
      <div class="flex items-center space-x-3">
        <div class="w-10 h-10 bg-gradient-to-br from-aggie-100 to-aggie-200 rounded-xl flex items-center justify-center">
    ...
    <div v-if="loading" class="px-8 py-12 text-center">
      ...
      <p class="text-base font-medium text-gray-700">Loading users...</p>
      <p class="text-sm text-gray-500 mt-1">Please wait while we fetch the user data</p>
    </div>
    ...
    <div v-else-if="error" class="px-8 py-12 text-center">
      ...
      <h3 class="text-lg font-semibold text-gray-900 mb-2">Failed to load users</h3>
      <p class="text-sm text-gray-600 mb-6 max-w-md mx-auto">{{ error }}</p>
      <button 
        @click="fetchUsers"
    ...
    <div v-else class="px-8 py-16 text-center">
      <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl mb-6">
        <svg class="w-10 h-10 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
        </svg>
      </div>
      <h3 class="text-lg font-semibold text-gray-900 mb-2">No users found</h3>
      <p class="text-sm text-gray-600 max-w-sm mx-auto">Users will appear here once they register for the platform</p>
    </div>
  </div>
</template>
